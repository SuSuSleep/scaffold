...
2. Read `.scaffold/metadata.md`, then resolve and read the active Knowledge Model, Knowledge Schema, Skills, Templates, and Rules from `.scaffold/`. These project-local artifacts are the complete active Harness. The installed package is only a candidate bundle for initialization and update review.
