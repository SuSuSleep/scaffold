...
description: Recover durable Project Knowledge from repository evidence while preserving warranted uncertainty.
---
...
- Existing durable project constraints when they are evidence for reconstruction.
