...
1. Read the active Project Rules, applicable Governance such as Verification Strategy or Coding Standards, and the relevant existing tests.
...
6. Run the relevant tests and report the result, including any constraint that prevented full verification. Do not encode project-specific testing strategy in this Skill.
