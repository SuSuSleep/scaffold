...
Scaffold must establish an acceptance-first lifecycle for meaningful changes and ensure Project Knowledge candidates are independently reconciled before they become accepted truth.

## Actors and Goals

- **Project owner**: decide whether a cleanly reviewed Project Knowledge candidate becomes accepted.
...
- A proposed Project Knowledge delta is reconciled against its accepted Git baseline through distinct writer/reviewer iterations.
