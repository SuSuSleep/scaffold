...
- If project-specific configuration still needs later completion, its explicit completion markers are visible and the user can resume project configuration later.

## Main Flow

1. The project developer or maintainer starts project preparation in the intended project directory and grants permission to create or update the scaffold.
...
5. The user starts project configuration to complete the project-specific information left by initialization.
...
- Initialization succeeds but setup is interrupted or fails: the initialized scaffold remains usable with explicit completion markers, and the user can resume project configuration. → See US-002
