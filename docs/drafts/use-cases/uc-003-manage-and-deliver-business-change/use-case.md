...
4. After every in-scope business draft is READY, the system translates the business intent into implementation contracts and one or more scenario-level implementation plans.
...
- A READY draft cannot be translated into a plan: no plan is written, and the blocking requirement, decision, or implementation boundary is reported. → See US-008
