...
- Unknown business intent SHALL be clarified or explicitly marked incomplete, never invented.
...
- Draft promotion SHALL be blocked while plan tasks remain incomplete or required behavioral tests are missing.
...
- Draft review finds incomplete or inconsistent business intent: drafts remain available, findings identify the required revisions, and the user reruns the review after correction. → See US-004, US-005, US-006, or US-007
