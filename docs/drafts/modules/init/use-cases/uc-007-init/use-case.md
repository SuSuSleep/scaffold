...
- **E6 — User says "no" to the HTTP-service question (Q10)** (recoverable): skip the `api-spec.yaml` write; do not list it in the summary; do not refer to it anywhere else in the scaffold
